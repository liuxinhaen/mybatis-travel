...
import com.example.mybatis.mapping.SqlCommandType;
...
/**
 * XML配置构建器，建造者模式，继承BaseBuilder 负责解析mybatis-config.xml 配置文件
 */
public class XMLConfigBuilder extends BaseBuilder {
    ...
    public Configuration parse() {
        try {
            // 解析映射器
            mapperElement(root.element("mappers"));//获取根元素下面的元素,得到所有mappers元素
        } catch (Exception e) {
